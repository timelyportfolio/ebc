<template>
  <div class="portal-data">
    <div class="row align-items-center" style="background-color:#d1dbe5;margin-top:1em;">
      <h4 style="font-weight:800; padding-top:10px;padding-left:10px;">DATA EXPLORER: CONSERVATION AND HUMAN WELL-BEING</h4>
    ...
    <div class="row" style="margin-top:0.5em;">
      ...
      <div class="col-md-9 ml-md-auto">      
        ...
        <div class="row">
          <keep-alive>
            <router-view :fulldata="fulldata" :filtered="filtered" :checkedfilters="checkedfilters"></router-view>
          </keep-alive>
        </div>
      </div>
    </div>
      ...
      calculateSummary: function(data) {
        return [
          ...
          },
          {
            ...
            number: this.getImpactCount(data)
          },
          {
            title: 'Open Access',
            number: this.getOpenCount(data)
          }
        ]
      }
    }
